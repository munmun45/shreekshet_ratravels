          ...
          <div class="about-travel-content">
            ...
            <div class="contact-info">
              ...
              <ul class="list-unstyled p-0 m-0 contact-info-inner-wrapper">
                <li><a href="mailto:support@traveltek.com"><i class="fa-solid fa-envelope"></i>info@shreekshetratravels.com</a></li>
                <li><a href="tel:+1(0800)123456"><i class="fa-solid fa-square-phone"></i> +919938437982</a></li>
                <li><i class="fa-solid fa-location-dot"></i> Puri, Odisha</li>
