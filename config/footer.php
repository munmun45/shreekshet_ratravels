<footer class="float-left w-100 position-relative main-box footer-con">
        ...
        <div class="container">
            ...
            <div class="copyright-con">
                <div class="row">
                    <div class="col-12">
                        <p class="text-size-16">Copyright ©2025 www.shreekshetratravels.com [All Rights Reserved]
                            <p class="text-size-16">Design By <a target="_blank" href="https://www.somasindia.com/">Somas Technology India Pvt Ltd</a></p>
                    </div>
                </div>
                <!-- copyright con -->
            </div>
