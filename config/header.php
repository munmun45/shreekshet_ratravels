...
<div class="w-100 float-left top-bar-con main-box">
            <div class="container">
                <div class="top-bar-inner-con d-flex align-items-center justify-content-between">
                    <div class="left-con">
                        <a href="mailto:info@shreekshetratravels.com"><i class="fa-solid fa-envelope"></i> info@shreekshetratravels.com</a>
                        <!-- left con -->
                    </div>
                    <div class="right-con"><a href="tel:+919938437982"><i class="fa-solid fa-square-phone"></i> 9938437982</a>
                        <!-- right con -->
                    </div>
                    <!-- top bar inner con -->
                </div>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="header-contact">
                            <ul class="list-unstyled mb-0">
                                <li><a href="contact.php" class="live-chat-btn d-inline-block"><i class="fa-solid fa-comment-dots"></i>
                                        Live Chat</a></li>
                                <!-- list unstyled -->
                            </ul>
                            <!-- header contact -->
